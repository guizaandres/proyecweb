...
<html>
    ...
    <body>
        <div id="contenedor">
            ...
            </section>             <div id ="definicon">
                <div><h>Marte (planeta) ... Recibió su nombre en homenaje
                        al dios de la guerra de la mitología romana 
                        (Ares en la mitología griega)
                        , y es también conocido como "el planeta rojo"​​ 
                        debido a la apariencia rojiza​ que le confiere 
                        el óxido de hierro predominante en su superficie.
