        ...
        <div id="contenedor">
            <header>
                <div id="enca">
                    ...
                    <div><h>La Tierra es el planeta que habitamos, 
                            ubicado en el sistema solar, luego de Mercurio y 
                            Venus, en cuanto a su cercanía al Sol, en la órbita
                            que despliega alrededor de ese astro, en su movimiento 
                            de traslación anual. 
                            Tiene también un movimiento de rotación diario,
                            que efectúa sobre su propio eje. 
                        </h></div>
                </div>
            </header>
